// client-core/src/animation/entrance.test.ts
...
describe('EntranceAnimation', () => {
  ...
  describe('start', () => {
    ...
    test('resets tick to 0', () => {
      ...
      entrance.update()
      entrance.update()
      entrance.start([{ id: 'a2', row: 0, col: 0, targetX: 10, targetY: 5 }])
      expect(entrance.getTick()).toBe(0)
    })

    test('clears previous aliens', () => {
      entrance.start([{ id: 'a1', row: 0, col: 0, targetX: 10, targetY: 5 }])
      entrance.start([{ id: 'a2', row: 0, col: 0, targetX: 20, targetY: 10 }])
  ...
  describe('update', () => {
    ...
    test('updates visual positions', () => {
      entrance.start([{ id: 'a1', row: 0, col: 0, targetX: 10, targetY: 20 }])
    ...
    test('transitions to formation when complete', () => {
      ...
      shortEntrance.start([{ id: 'a1', row: 0, col: 0, targetX: 10, targetY: 5 }])
  ...
  describe('patterns', () => {
    test('rain pattern - columns animate together', () => {
      ...
      expect(Math.abs(s1!.startTick - s2!.startTick)).toBeLessThan(Math.abs(s1!.startTick - s3!.startTick))
    })
  ...
  describe('animateX option', () => {
    test('keeps X constant when animateX is false', () => {
      ...
      noX.start([{ id: 'a1', row: 0, col: 0, targetX: 50, targetY: 20 }])
