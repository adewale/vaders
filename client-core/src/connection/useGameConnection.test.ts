// client-core/src/connection/useGameConnection.test.ts
...
): 'reconnect' | 'stop_intentional' | 'stop_game_over' | 'stop_max_attempts' {
...
function handleMessage(msg: ServerMessage, currentState: ConnectionState): Partial<ConnectionState> | null {
  if (msg.type === 'pong') {
