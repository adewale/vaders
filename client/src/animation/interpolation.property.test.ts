// client/src/animation/interpolation.property.test.ts
...
describe('toRenderPosition (property-based)', () => {
  it('cellX = floor(visualX) and cellY = floor(visualY)', () => {
    fc.assert(fc.property(arbSubPosition, arbSubPosition, (vx, vy) => {
...
describe('lerpPosition (property-based)', () => {
  it('at t=0 returns prev position', () => {
    fc.assert(fc.property(arbPosition, arbPosition, arbPosition, arbPosition, (px, py, cx, cy) => {
  ...
  it('result is between prev and current for t in [0, 1]', () => {
    fc.assert(fc.property(
      arbPosition, arbPosition, arbPosition, arbPosition, arbUnitInterval,
      (px, py, cx, cy, t) => {
  ...
  it('lerp from a point to itself returns that point', () => {
    fc.assert(fc.property(arbPosition, arbPosition, arbUnitInterval, (px, py, t) => {
